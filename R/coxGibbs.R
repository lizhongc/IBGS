...
#
# The chain starts from the empty model (no covariates; the Cox model has no
# intercept) and grows, which avoids the ill-conditioned saturated start where the
# criterion (notably AICc) can be degenerate.
#
# Arguments:
